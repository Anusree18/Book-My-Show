...
const NavSm = () =>{
    ...
    <div className="text-white flex items-center justify-between">
        ...
        <div type="search" className="w-8 h-8">
...
const NavMd = () =>{
    return (
        ...
        <input 
            type="search"
            className="w-full bg-transaprent border-none focus:outline-none" 
    ...
    return (
        <div className="container mx-auto px-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
                <span className="text-gray-200 text-xs flex items-center hover:test-white ">
